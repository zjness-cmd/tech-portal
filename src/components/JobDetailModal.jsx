...
export default function JobDetailModal({ job, accessToken, checkedIn, checkedOut, completed, onClose, onNotesSaved }) {
      ...
      React.createElement("div", { style: { overflowY: "auto", flex: 1, padding: "1rem 1.25rem" } },
        ...
        React.createElement("div", { style: { marginBottom: 16 } },
          ...
          React.createElement("textarea", {
            ...
            placeholder: "Add notes about this job — customer info, equipment issues, follow-ups...",
        ...
        // Photos
        React.createElement("div", { style: { marginBottom: 16 } },
          React.createElement("div", { style: { fontSize: 12, fontWeight: 700, color: "#888", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 8 } }, "📷 Photos"),
          photos.length > 0 && React.createElement("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 8, marginBottom: 10 } },
            photos.map((p, i) => React.createElement("a", { key: i, href: p.url, target: "_blank", rel: "noreferrer", style: { display: "block", borderRadius: 8, overflow: "hidden", aspectRatio: "1", background: "#f5f5f3" } },
              React.createElement("img", { src: p.thumb, alt: p.name, style: { width: "100%", height: "100%", objectFit: "cover" } })
            ))
          ),
          React.createElement("input", { ref: fileInputRef, type: "file", accept: "image/*", multiple: true, style: { display: "none" }, onChange: handlePhotoUpload }),
          React.createElement("button", {
            onClick: () => fileInputRef.current?.click(),
            disabled: uploading,
            style: { width: "100%", padding: "12px", borderRadius: 10, border: "2px dashed #ccc", background: "#fafafa", color: "#666", cursor: "pointer", fontSize: 14, fontWeight: 500 },
